        ...
        return (
            <React.Fragment>
                <Helmet>
                    ...
                    {_.get(this.props, 'page.frontmatter.seo.canonical_url', null) ? (
                    <link rel="canonical" href={_.get(this.props, 'page.frontmatter.seo.canonical_url', null)} />
                    ) : (_.get(this.props, 'data.config.domain', null) && ((() => {
                        let domain = _.trim(_.get(this.props, 'data.config.domain', null), '/');
                        let page_rel_url = withPrefix(_.get(this.props, 'page.__metadata.urlPath', null));
                        return (
